...
class AccountInformationForm(forms.ModelForm):
    date_of_birth = forms.DateField(required=False, widget=forms.TextInput(attrs={'placeholder':"", "type": "date"}))
    acc_name = forms.CharField(required=False, label="Full Name", widget=forms.TextInput(attrs={'placeholder':"name...."}))
    class Meta:
        model = AccountProfile
        fields = ('account_type', "acc_name", "date_of_birth")
